...
// Knuckle Bash board-local derivative. The top remains identical to the
// protected JT6295 integration except that it binds the board-local serial
// scheduler with MAME-compatible inclusive phrase-end semantics.

module knuckle_bash_jt6295(
    input                  rst,
    input                  clk,
...
knuckle_bash_jt6295_serial u_serial(
    .rst        ( rst           ),
    .clk        ( clk           ),
    .cen        ( cen_sr        ),
    .cen4       ( cen_sr4       ),
